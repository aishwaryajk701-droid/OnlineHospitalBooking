...
<head>
    ...
    <style>
        body {
            background: url('img/categoryAdmin.png') no-repeat center center/cover;
...
<div class="container">
    <div class="illustration">
        ...
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Circle background -->
            <circle cx="100" cy="100" r="80" fill="url(#adminGradient)" opacity="0.1"/>
            <!-- Admin Body -->
            <circle cx="100" cy="80" r="25" fill="#fbbf77"/>
            <rect x="65" y="110" width="70" height="50" rx="10" fill="#3b82f6"/>
            <rect x="75" y="115" width="50" height="40" rx="8" fill="#2563eb"/>
            <!-- Tie -->
            <polygon points="95,110 105,110 100,135" fill="#ffffff"/>
            <!-- Briefcase Icon -->
            <rect x="80" y="150" width="40" height="25" rx="3" fill="#3b82f6"/>
            <rect x="85" y="145" width="30" height="5" rx="2" fill="#2563eb"/>
            <rect x="95" y="160" width="10" height="8" fill="#ffffff"/>
        </svg>
    </div>
    <form action="" method="POST" id="loginForm">
        ...
        <div style="margin-top:20px;">
            ...
            <a href="signup_admin.php" class="hover-link1 non-style-link"> Sign Up</a>
        </div>
    </form>
</div>
</center>
