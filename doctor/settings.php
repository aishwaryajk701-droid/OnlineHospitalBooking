                ...
                <tr>
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <a href="payment_settings.php" class="non-style-link">
                                        <div class="dashboard-items setting-tabs" style="padding:20px;margin:auto;width:95%;display:flex;">
                                            <div class="btn-icon-back dashboard-icons-setting" style="background-image: url('../img/icons/payment.svg');"></div>
                                            <div>
                                                <div class="h1-dashboard">Payment Details</div><br>
                                                <div class="h3-dashboard" style="font-size: 15px;">
                                                    Add UPI ID & Upload QR Code
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="spec" class="form-label">Specialties: (Current '.$spe.')</label>
                                            
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="spec" class="input-text" placeholder="Specialties" value="'.$spe.'" required><br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
