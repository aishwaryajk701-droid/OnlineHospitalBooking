...
<body>
    ...
    // Fetch doctor details with correct column names
                                ...
                                <td>
                                    ...
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            // Correct JOIN with new db structure
                                            $sqlmain = "
                                                SELECT 
                                                    schedule.scheduleid,
                                                    schedule.title,
                                                ...
                                                FROM schedule
                                                INNER JOIN doctor 
                                                    ON schedule.docid = doctor.doctor_id
                                            ...
                                            if($result->num_rows==0){
                                                ...
                                                while($row = $result->fetch_assoc()){
                                                    echo '<tr>
                                                        ...
                                                        <td style="padding:20px;font-size:13px;">'.$row["scheduledate"].'</td>
